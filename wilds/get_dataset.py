...
def get_dataset(
    ...
    **dataset_kwargs,
    ...
    if unlabeled and dataset not in wilds.unlabeled_datasets:
        raise ValueError(
            f"Unlabeled data is not available for {dataset}. Must be one of {wilds.unlabeled_datasets}."
        )

    if dataset == "amazon":
        if unlabeled:
            from wilds.datasets.unlabeled.amazon_unlabeled_dataset import (
                AmazonUnlabeledDataset,
            )
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.camelyon17_unlabeled_dataset import (
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.civilcomments_unlabeled_dataset import (
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.domainnet_unlabeled_dataset import (
                DomainNetUnlabeledDataset,
            )
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.iwildcam_unlabeled_dataset import (
            ...
            if version == "1.0":
                ...
                from wilds.datasets.iwildcam_dataset import (
                    IWildCamDataset,
                )  # type:ignore
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.ogbmolpcba_unlabeled_dataset import (
                OGBPCBAUnlabeledDataset,
            )
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.poverty_unlabeled_dataset import (
            ...
            if version == "1.0":
                from wilds.datasets.archive.poverty_v1_0_dataset import (
                    PovertyMapDataset,
                )
            else:
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.fmow_unlabeled_dataset import (
        ...
        if unlabeled:
            from wilds.datasets.unlabeled.globalwheat_unlabeled_dataset import (
                GlobalWheatUnlabeledDataset,
            )

            return GlobalWheatUnlabeledDataset(version=version, **dataset_kwargs)
        else:
            from wilds.datasets.globalwheat_dataset import (
                GlobalWheatDataset,
            )  # type:ignore
